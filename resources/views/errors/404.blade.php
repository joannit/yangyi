...
<head>
	...
	<title>Metronic | Extra - 404 </title>
...
<body class="page-404-3">
	...
	<div class="page-inner">
		...
		<img src="/static/admin/image/earth.jpg" alt="">
	...
	<script src="/static/admin/js/respond.js"></script>  

	<![endif]-->   

	<script src="/static/admin/js/breakpoints.js" type="text/javascript"></script>  
