     ...
     <table class="table table-striped table-bordered table-hover table-full-width dataTable" id="sample_2" aria-describedby="sample_2_info"> 
      <thead> 
       <tr role="row">
        ...
        <th class="hidden-480 sorting" role="columnheader" tabindex="0" aria-controls="sample_2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 80px;">库存</th>
      ...
      @foreach($goods as $row)
       <tr class="odd"> 
        ...
        <td class="hidden-480 ">{{$row->store}}</td>
        <td class="hidden-480 ">{{$row->status}}</td>
        <td class="hidden-480 ">{{$row->sales}}</td>
        <td class="hidden-480 "><div class="img"><img src="/uploads/goods/{{$row->pic}}">
        </div></td>
        <td class="hidden-480 ">
        <ul>
        <li class="fl">
        <a href="#" class="btn  icn-only"><i class="halflings-icon remove white icon-zoom-in"></i></a>
        </li>
        <li class="fl">
        <a href="/admin/goods/{{$row->id}}/edit" class="btn blue icn-only"><i class=" icon-pencil"></i></a>
        </li>
        <li class="fl">
