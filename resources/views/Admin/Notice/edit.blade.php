...
<script type="text/javascript" charset="utf-8" src="/static/admin/ueditor/lang/zh-cn/zh-cn.js"></script>
  <div class="portlet box blue"> 
   ...
   <div class="portlet-body form"> 
    <h3 class="block"></h3> 
    <!-- BEGIN FORM--> 
    <form action="/admin/notice/{{$info->id}}" class="form-horizontal" method="post"> 
     <div class="control-group "> 
      <label class="control-label" for="inputWarning">标题</label> 
      <div class="controls"> 
       <input type="text" class="span6 m-wrap" id="inputWarning" name="title" value="{{$info->title}}" /> 
     ...
     <div class="form-actions"> 
      ...
      <a href="/admin/notice" class="btn">Cancel</a> 
     </div> 
     {{method_field('PUT')}}
     {{csrf_field()}}
    </form> 
