...
<div class="pull-right"> 
   <div class="user-content__box clearfix bgf"> 
    ...
    <form action="/paddress/doeditadd" class="user-addr__form form-horizontal" role="form" method="post" id="fr"> 
     <p class="fz18 cr">修改收货地址</p> 
     <div class="form-group"> 
      <label for="name" class="col-sm-2 control-label">收货人姓名：</label> 
      <div class="col-sm-6"> 
       <input class="form-control" name="aname" placeholder="请输入姓名" type="text" required value="{{$info->aname}}" /> 
    ...
    <div class="addr-linkage">
       ...
       <input class="form-control" id="details" placeholder="建议您如实填写详细收货地址，例如街道名称，门牌号码等信息" maxlength="30" type="text" value="{{$info->address}}" name="address_info" required>
      </div> 
     </div> 
     ...
     <div class="form-group"> 
      ...
      <div class="col-sm-6"> 
       <input class="form-control" id="mobile" placeholder="请输入手机号码" type="text" name="aphone" required value="{{$info->aphone}}" /> 
       <span></span>
      </div> 
     </div>  
     {{csrf_field()}}
